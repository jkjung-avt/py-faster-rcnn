...
6. Run the following command to start training. This trains the model for 90,000 iterations. And it writes logs to './experiments/logs/brainwash-1.log'.
...
6. To test the trained model (taking snapshot #90,000 as example). The output is the mAP value.
...
8. To deploy the trained model onto Jetson TX2, you mainly need the trained caffemodel snapshot: './output/faster_rcnn_end2end/brainwash_train/brainwash_vgg16_iter_90000.caffemodel'
