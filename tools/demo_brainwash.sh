...
def demo(net, image_name):
    ...
    # Load the demo image
    im_file = os.path.join(cfg.DATA_DIR, 'demo/brainwash', image_name)
...
if __name__ == '__main__':
    ...
    im_dir = os.path.join(cfg.DATA_DIR, 'demo/brainwash')
    im_names = [f for f in os.listdir(im_dir) if f.endswith('.png')]
    import random
